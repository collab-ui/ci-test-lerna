...
import iconPaths from '@collabui/icons/data/iconsData.json';
import colors from '@collabui/core/data/colors.json';
    ...
    const consoleHandler = (message, data) => {
      ...
      switch (message) {
        case 'isAria-warn': // TODO(pajeter): remove isAria code with next major release
          console.warn(
            `[@collabui/react] Icon: isAria prop is deprecated and will be removed. Title, description or ariaLabel props should be used to add accessibility.`
          );
          break;
        case 'color-warn':
          console.warn(
            `[@collabui/react] Icon: ${data} may not exist in the design system,` +
              ` please use a color name from http://core.collab-ui.com/styles/colors`
          );
          break;
        case 'color-error':
          console.warn(
            `[@collabui/react] Icon: ${data} does not exist in the design system,` +
              ` please use a color name from http://core.collab-ui.com/styles/colors`
          );
          break;
          case 'name-error':
          console.warn(
            `[@collabui/react] Icon: Icon ${data} does not exist in the design system.` +
