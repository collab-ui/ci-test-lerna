...
class SubMenu extends React.Component {
  ...
  componentDidMount() {
    ...
    if (!children) {
      throw new Error(`[@collabui/react] SubMenu: children are required for this component.`);
    } else if (!this.verifyChildrenElements(['MenuItem', 'SubMenu'])) {
      throw new Error(`[@collabui/react] SubMenu: children must be SubMenu or MenuItem`);
    }
  }
